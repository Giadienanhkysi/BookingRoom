                ...
                <div class="grid wide">
                    <div class="row">
                        <div class="col l-6 m-5 c-5  logo-and-search">
                            <h1><a class="login-logo" href='<c:url value="/trang-chu"/>'>
                                    Booking Room
                                </a></h1>
                    ...
                    <div class="grid wide">
                        <div class="row">
                            <div class="col l-12 m-12 c-12">
                                <h2 class="login-welcome__header">Đăng ký thành viên </h2>
                                <p class="login-welcome__content">Nhanh chóng, tiện lợi và an toàn. Đăng ký ngay bây giờ để trải nghiệm</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col l-6 m-12 c-12">
                                        <div class="media__item">
                                            ...
                                            <p class="media__item-content">Tích điểm đối với mỗi lượt đặt chỗ thành công.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col l-6 m-12 c-12">
                                        <div class="media__item">
                                            ...
                                            <p class="media__item-content">Check-in và kiểm tra hóa đơn thanh toán kể cả khi
                                                không có kết nối mạng. Hoàn tiền nhanh gọn. Đổi lịch dễ dàng.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col l-6 m-12 c-12">
                                        <div class="media__item">
                                            ...
                                            <p class="media__item-content">Phương thức thanh toán tiện lợi, an toàn. Tích
                                                hợp chức năng lưu thẻ để đặt phòng lần sau.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col l-6 m-12 c-12">
                                        <div class="media__item">
                                            ...
                                            <p class="media__item-content">Nhận thông báo ưu đãi từ chúng tôi khi có kế
                                                hoạch du lịch để lựa chọn và đặt ngay cho mình một chỗ ở phù hợp, tiện nghi
                                                với giá tốt nhất.</p>
                                        </div>
                                    </div>
                        ...
                        <div class="col l-4 m-12 c-12 form-mobile">
                            <div class="account">
                                <form action="" id="form-1">
                                    <h1 class="account__header">Đăng ký thành viên</h1>
                                    <div class="form-group">
                                        <label for="username" class="account__title">Tài khoản</label>
                                        <input placeholder="Tài khoản" name="username" type="text"
                                               class="form-input account__input" id="username">
                                        <span class="form-message"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="email" class="account__title">Địa chỉ email</label>
                                        <input placeholder="Email" name="email" type="text"
                                               class="form-input account__input " id="email">
                                        <span class="form-message"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="phone" class="account__title">Số điện thoại</label>
                                        <input name="phone" id="phone" placeholder="Số điện thoại" type="text"
                                               class="form-input account__input">
                                        <span class="form-message"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="firstname" class="account__title">Tên</label>
                                        <input placeholder="Tên" name="firstname" id="firstname" type="text"
                                               class="form-input account__input">
                                        <span class="form-message"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="lastname" class="account__title">Họ và tên đệm</label>
                                        <input placeholder="Họ tên đệm" name="lastname" id="lastname" type="text"
                                               class="form-input account__input">
                                        <span class="form-message"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="gender" class="form-label account__title">Giới tính</label>
                                    ...
                                    <div class="form-group">
                                        <label for="password" class="account__title">Mật khẩu</label>
                                        <input placeholder="Mật khẩu" id="password" name="password" type="password"
                                               class="form-input account__input ">
                                        <span class="form-message"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="password--confirm" class="account__title">Xác nhận mật khẩu mới</label>
                                        <input placeholder="Xác nhận mật khẩu" id="password--confirm"
                                               name="password--confirm" type="password" class="form-input account__input ">
                                        <span class="form-message"></span>
                                    </div>

                                    <div class="account__body">
                                        <button class="submit submit--inter">Đăng ký</button>
                                        <div class="quest">
                                            <span>Bạn đã có tài khoản ? <a href="/dang-nhap?action=login" class="login-link">Đăng
                                                    nhập</a></span>
                                        </div>
                                    </div>
